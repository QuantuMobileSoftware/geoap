...
NOTEBOOK_EXECUTOR_MAX_NOTEBOOKS_IN_PROGRESS = 1
...
EXECUTOR_CONTAINER_NETWORK = os.getenv('EXECUTOR_CONTAINER_NETWORK', 'geoap_sip')
...
GEOAPP_INTERNAL_API_BASE_URL = os.getenv('GEOAPP_INTERNAL_API_BASE_URL', 'http://webapplication:9000')
try:
