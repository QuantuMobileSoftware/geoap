...
NOTEBOOK_VALIDATION_JOB_BACKOFF_LIMIT = os.getenv("NOTEBOOK_VALIDATION_JOB_BACKOFF_LIMIT", 1)
NOTEBOOK_VALIDATION_JOB_ACTIVE_DEADLINE = os.getenv('NOTEBOOK_VALIDATION_JOB_ACTIVE_DEADLINE', 36_000) # 10 hours in seconds
K8S_NAME_SPACE = os.getenv('K8S_NAME_SPACE','sip')
IMAGE_PULL_SECRETS = os.getenv('IMAGE_PULL_SECRETS', 'regcred')
NOTEBOOK_EXECUTOR_MAX_JOBS = os.getenv('NOTEBOOK_EXECUTOR_MAX_JOBS', 2)
NOTEBOOK_VOLUME_MOUNT_PATH = os.getenv('NOTEBOOK_VOLUME_MOUNT_PATH', '/home/jovyan/work')
