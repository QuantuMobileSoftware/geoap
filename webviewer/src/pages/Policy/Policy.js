...
import { Container, Header, MainTitle, BackLink } from './Policy.styles';
...
export const Policy = () => {
  return (
    <>
      ...
      <Container>
        <Header>
          <MainTitle>Soilmate.ai Privacy Policy</MainTitle>
        ...
        <ol>
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                ...
                business. If you use a third-party authentication provider (e.g. “Google
                Login”), we use the data obtained from this provider (email and name) in
                the same manner.
              </li>
              <li>
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                ...
                namely the use of standard data protection clauses adopted or approved by
                the European Commission, a copy of which can be obtained from
              ...
              <li>
                ...
                respect to the data protection laws of each of these countries. Transfers
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                ...
                additional copies may be subject to a reasonable fee. You can request a
                copy by contacting us at support@soilmate.ai.
              </li>
              <li>
              ...
              <li>
                ...
                the legal basis for the processing is that the processing is necessary
                for: the performance of a task carried out in the public interest or in
                the exercise of any official authority vested in us; or the purposes of
                the legitimate interests pursued by us or by a third party. If you make
                such an objection, we will cease to process the personal information
            ...
            <ol>
              ...
              <li>
                ...
                <p>
                  ...
                  evaluation procedure and your rights of objection. By subscribing to our
                  newsletter you agree to the receipt and the described procedures. The
                  following information informs you about the contents of our newsletter
                  as well as the registration, dispatch and statistical evaluation
                  procedure and your rights of objection. By subscribing to our newsletter
                  you agree to the reception and the described procedures.
                </p>
                <p>
                  ...
                  “newsletters”) only with the recipients consent or legal permission. If
                  the content of a newsletter is specifically described as part of the
                  registration, this is are decisive for the users’ consent. In addition,
                  our newsletters contain information about us and our services.
                </p>
                <p>
                  Double opt-in and logging: Subscription to our newsletter takes place in
                  a so-called double opt-in procedure. This means that after registration
                  you will receive an e-mail asking you to confirm your registration. This
                  confirmation is necessary so that no one can log in with other e-mail
                  addresses. Subscriptions to the newsletter are logged in order to be
                  able to prove the registration process in accordance with legal
                  requirements. This includes the storage of the login and confirmation
                  time.
                </p>
                <p>
                  The dispatch of the newsletter and the performance measurement
                  associated with it are based on the recipient’s consent pursuant to Art.
                  6 para. 1 lit. a, Art. 7 GDPR in conjunction with § 7 para. 2 no. 3 UWG
                  or, if consent is not required, on the basis of our legitimate interests
                  in direct marketing pursuant to Art. 6 para. 1 lit. f. GDPR in
                  conjunction with Section 7 para. 3 UWG. The registration procedure is
                  recorded on the basis of our legitimate interests pursuant to Art. 6
                  para. 1 lit. f GDPR. We are interested in the use of a user-friendly and
                  ...
                  Cancellation/Withdrawal – You can cancel the receipt of our newsletter
                  at any time, i.e. withdraw your consent, through a cancelation link at
                  the end of each newsletter. In order to prove a previously given
                  consent, we may store the unsubscribed e-mail addresses for up to three
                  years on the basis of our legitimate interests before deleting them. The
                  processing of this data is limited to the purpose of a possible defence
                  against claims. An individual application for cancellation is possible
                  at any time, provided that a former existence of a consent is confirmed
                  at the same time.
                </p>
                <p>
                  In addition to our newsletter, we also send out marketing communications
                  by e-mail to inform our insurance customers and account users about our
                  product range as well as special promotions and offers. This is done on
                  the basis of our legitimate interest pursuant to Art. 6 para. 1 lit. f
                  GDPR. As a young company, our legitimate interest is to keep our clients
                  and account users constantly informed about our expanding range of
                  insurance products. There is no recognizable overriding interest
                  opposing this. Our clients and account users are informed of this
                  process at the time the e-mail address is collected and can unsubscribe
                  from these marketing communications at any time. The balancing of
                  interests pursuant to Art. 6 (1) sentence 1 lit. f DS-GVO is therefore
                  in favour of the permissibility of processing this contact data for
                  direct advertising purposes.
                </p>
              </li>
              <li>
                Google Analytics. On the basis of our legitimate interests (i.e. interest
                in the analysis, optimisation and economic operation of our online offer
                in the sense of Art. 6 para. 1 lit. f. GDPR), in our website and in all
                subdomains we make use of Google Analytics in accordance with the
                following GDPR principles . Google uses cookies. The information generated
                ...
                <p>
                  ...
                  other Google data. Users may refuse the use of cookies by selecting the
                  appropriate settings on their browser, they may also refuse the use of
                  cookies by selecting the appropriate settings on their browser, they may
                  refuse the collection of information by Google regarding the use of
                  cookies and the processing of such information by Google by selecting
                  the appropriate settings on their browser, and they may refuse the use
                  of cookies by selecting the appropriate settings on their browser, and
                  they may refuse the use of cookies by selecting the appropriate settings
                  on their browser, and by downloading and installing the browser plug-in
              ...
              <li>
                Google Adwords and Conversion Measurement. On the basis of our legitimate
                ...
                GDPR) we use the services of Google Ireland Limited, Gordon House, Barrow
                Street, Dublin 4, Ireland, (“Google”). Google is certified under the
                ...
                potentially correspond to their interests. For example, if a user is shown
                ads for products in which they have displayed prior interest in other
                online offers, this is referred to as “remarketing”. For these purposes,
                when our website and others on which the Google Advertising Network is
                active are accessed, Google directly executes a code from Google and
                (re)marketing tags (invisible graphics or code, also known as “web
                beacons”) are integrated into the website. With their help, an individual
                cookie, i.e. a small file, is stored on the user’s device (comparable
                technologies can also be used instead of cookies). In this file it is
                noted which websites the user visits, which content they are interested in
                and which offers the user has clicked on, technical information on the
                browser and operating system, referring websites, visiting time and
                further information on the use of the online offer. We also receive an
                individual “conversion cookie”. The information collected with the help of
                cookies is used by Google to generate conversion statistics for us.
                However, we only see the total number of anonymous users who clicked on
                our ad and were redirected to a page with a conversion tracking tag.
                However, we do not receive any information that personally identifies
                users. User data is processed pseudonymously within the Google advertising
                network. This means that Google does not store and process, for example,
                the names or e-mail addresses of users, but processes the relevant data
                cookie-related within pseudonymous user profiles. This means from Google’s
                point of view, the ads are not managed and displayed for a specifically
                identified person, but for the cookie holder, regardless of who this
                cookie holder is. This does not apply if a user has expressly permitted
                Google to process the data without this pseudonymisation. The information
                collected about the users is transmitted to Google and stored on Google’s
                servers in the USA. Further information on data use by Google, possible
                settings and objections can be found in Google’s data protection
                declaration (https://policies.google.com/technologies/ads) and in the
                settings for the display of advertisements by Google
                (https://adssettings.google.com/authenticated). You may also object to the
                use of cookies for range measurement and advertising purposes via the
              ...
              <li>
                <p>
                  ...
                  optimisation and economic operation of our online offer in the sense of
                  Art. 6 para. 1 lit. f. GDPR), we make use of the tool Hubspot from
                  ...
                  marketing, reporting (traffic sources, accesses,…), contact management,
                  landing page tracking.
                </p>
                <p>
                  This tool makes use of web beacons and under certain circumstances
                  “cookies” are also set, which are stored on your computer and enable us
                  to analyse your use of the website. Hubspot analyses the collected
                  ...
                  on the pages visited. For more information on how Hubspot works, please
                  refer to the Hubspot Inc. privacy policy at:
                  http://legal.hubspot.com/de/privacy-policy If a user generally does not
                  wish to be recorded by Hubspot, the storage of cookies can be prevented
                  at any time by appropriate browser settings.
                </p>
                <p>
              ...
              <li>
                ...
                services. When accessing the respective networks and platforms, the terms
                and conditions and the data processing guidelines of their respective
                operators apply. Unless otherwise stated in our privacy policy, we process
                the data of users who communicate with us within social networks and
                platforms, e.g. write articles on our websites or send us messages. We
                ...
                <p>
                  ...
                  European Union. This can pose risks for users because, for example, the
                  enforcement of users’ rights could be made more difficult. With regard
                  to US providers certified under the Privacy Shield, we would like to
                  point out that they commit themselves to comply with EU data protection
                  standards. Furthermore, user data is usually processed for market
                  research and advertising purposes. Thus, for example, user profiles can
                  be created from the user behavior and the resulting interests of the
                  users. The usage profiles can in turn be used, for example, to place
                  advertisements inside and outside the platforms that presumably
                  ...
                  behavior and interests are stored. Furthermore, data can also be stored
                  in the user profiles independently of the devices used by the users
                  (especially if the users are members of the respective platforms and are
                  logged in to these). The processing of users’ personal data is carried
                  out on the basis of our legitimate interests in effective user
                  information and communication with users pursuant to Art. 6 para. 1 lit.
                  f. GDPR. If the users are asked by the respective providers for consent
                  to data processing (i.e. to give their consent e.g. by ticking a
                  checkbox or confirming a button), the legal basis of processing is Art.
                  6 para. 1 lit. a., Art. 7 GDPR. For a detailed description of the
                  respective processing and the possibilities of objection (opt-out), we
                  refer to the information provided by the providers linked below. Also in
                  the case of requests for information and the assertion of user rights,
                  we point out that these can be asserted most effectively with the
                ...
                <p>
                  ...
                  94103, USA) – Privacy Policy: https://twitter.com/en/privacy, Opt-Out:
                ...
                <p>
                  LinkedIn (LinkedIn, 1000 W Maude Ave, Sunnyvale, California, 94085, USA)
              ...
              <li>
                LinkedIn. Within our online offer, functions and contents of the LinkedIn
                service, offered by LinkedIn 1000 W Maude Ave, Sunnyvale, California,
                94085, USA, can be integrated. This may include, for example, content such
                as images, videos or texts and buttons with which users can share content
                from this online offer within LinkedIn. If the users are members of the
                LinkedIn platform, LinkedIn can assign the call of the above contents and
                functions to the profiles of the users there. Privacy Policy of LinkedIn:
                https://www.linkedin.com/legal/privacy-policy. LinkedIn is certified under
                the Privacy Shield Agreement and thus offers a guarantee to comply with
                European data protection law
                (https://www.privacyshield.gov/participant?id=a2zt0000000L0UZAA0&status=Active).
                Privacy Policy: https://www.linkedin.com/legal/privacy-policy, Opt-Out:
                https://www.linkedin.com/psettings/guest-controls/retargeting-opt-out.
                <p>
                  On the basis of our legitimate interests (i.e. interest in the analysis
                  of our online offer in the sense of Art. 6 para. 1 lit. f. GDPR), we
                  make use of some services from LinkedIn (1000 W Maude Ave, Sunnyvale,
                  California, 94085, USA) as described below. We use the site-wide Insight
                  Tag on all our website pages to record actions taken by members reaching
                  a specific URL and also the event-specific pixel to track conversions
                  without an associated URL. The LinkedIn Insight Tag enables the
                  collection of data regarding members’ visits to your website, including
                  the URL, referrer, IP address, device and browser characteristics,
                  timestamp, and page views. This data is encrypted, then de-identified
                  within seven days, and then de-identified data is deleted within 90
                  days. LinkedIn does not share the personal data with us, it only
                  provides aggregated reports about the website audience and ad
                  performance. LinkedIn also provides retargeting for website visitors,
                  enabling us to show personalized ads off the website by using this data,
                  but without identifying the member.
                </p>
                <p>
              ...
              <li>
                ...
                Harbour, Dublin 2, Ireland (“Facebook”), is used within our online offer.
                <p>
                  ...
                  collected: Full name, email address, mobile number, postal code as well
                  as the product for which information is requested. We use the
                ...
                <p>
                  ...
                  to display the Facebook ads we post only to Facebook users who have also
                  shown an interest in our online offering or who have certain features
                  (e.g. interests in certain topics or products that are determined by the
                  websites visited) that we transmit to Facebook (so-called “custom
                  audiences”). We also want to use the Facebook pixel to ensure that our
                  Facebook ads meet the potential interest of users and are not a
                  nuisance. The Facebook pixel also helps us understand the effectiveness
                  of Facebook ads for statistical and market research purposes by showing
                  whether users have been redirected to our website after clicking on a
                  Facebook ad (so-called “conversion”). Facebook processes the data in
                  accordance with Facebook’s Data Usage Policy. Accordingly, general
                  information on the display of Facebook ads is contained in the Facebook
                  Data Usage Policy: https://www.facebook.com/policy. For specific
                  information and details about the Facebook pixel and how it works,
                  please visit the Facebook Help section:
                  https://www.facebook.com/business/help/651294705016616. You can object
                  to the collection by the Facebook pixel and use of your data to display
                  Facebook ads. To set what types of ads you see within Facebook, you can
                  visit the page set up by Facebook and follow the instructions on
                  usage-based advertising settings:
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                We are registered in Poland under registration number VAT: PL 5242935926,
                and our registered office is at str. Modlińska 6A/223, 03-216 Warszawa,
                Poland
              </li>
              <li>
                You can contact us:
